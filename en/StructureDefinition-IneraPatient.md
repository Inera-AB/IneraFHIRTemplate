...
* Examples for this Profile: [Patient/IneraPatientExample](Patient-IneraPatientExample.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/inera.core.template|current/StructureDefinition/StructureDefinition-IneraPatient.json)
...
```json
{
  ...
  "title" : "Inera Patient",
  "status" : "draft",
  "date" : "2026-06-25T07:04:27+00:00",
  "publisher" : "Inera AB",
  "contact" : [{
    "name" : "Inera AB",
    "telecom" : [{
