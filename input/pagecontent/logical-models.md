...
| Logisk modell | Beskrivning |
|---------------|-------------|
| *[[Modellnamn]](StructureDefinition-[Modellnamn].html)* | *Beskriv vilken information denna modell fångar och i vilket sammanhang den används.* |
