...
> **Vägledning för författare:** Håll denna sida kort. Roller, ansvar och arbetsflödet beskrivs under [Funktionellt](functional.html). Tekniska detaljer om REST-anrop, sökparametrar och konformanskrav hör hemma under Implementering (se t.ex. [CapabilityStatement](capabilitystatement.html)).
